        ...
        @section('content')
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="py-3 mb-4"><span class="text-muted fw-light">Jurusan /</span> List</h4>
                <div class="card">
                    @if (session('success'))
                    ...
                    <h5 class="card-header">Jurusan
                        <a href="{{ route('jurusan.create') }}" class="btn btn-md btn-info" style="float: right">Tambah</a>
                    </h5>
