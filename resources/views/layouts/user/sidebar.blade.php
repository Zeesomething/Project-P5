<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="index.html" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bold  ms-n3 ">SMK ASSALAAM</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item open mt">
            ...
            <ul class="menu-sub">
                <li class="menu-item active">
                    <a href="{{ route('eskul') }}" class="menu-link">
                ...
                <li class="menu-item active">
                    <a href="{{ route('struktural') }}" class="menu-link">
                        <div data-i18n="Analytics">Struktural</div>
                    </a>
                </li>
            </ul>
        </li>
